...
def get_targetID(targetLayer,targetStrip,targetEnd):
    if targetLayer <= 9:
...
if len(sys.argv) == 3:
    ...
    recreate_MIP_response_plot(targetLayer, targetStrip, 0)
    recreate_MIP_response_plot(targetLayer, targetStrip, 1)
